...
function Navbar({  }) {
  ...
  // write a function to log out of metamask
  ...
  return (
    <>
      <div className="flex justify-between flex-wrap select-none">
        ...
        <form className="flex items-center justify-center mx-auto order-2 md:order-1 px-4">
          ...
          <div className="relative max-w-full">
            ...
            <input
              type="text"
              id="simple-search"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5 max-w-full sm:w-96 w-72"
        ...
        <button
          type="button" onClick={loginStatus ? handleLogout : handleLogin}
          class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-full sm:rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mx-6 my-8 sm:my-10 md:order-2"
        >
          <svg
            aria-hidden="true"
            class="mx:auto sm:mr-2 -ml-1 w-6 h-5"
          ...
          {account==="" && "Connect with MetaMask" || account!=="" && account.slice(0,6) + "..."}
          </span>
        </button>
      </div>
      ...
      <nav className="select-none sm:border-b pt-2 overflow-x-scroll sm:overflow-hidden pb-3 flex sm:justify-center md:border scrollbar md:justify-end">
          <Link href="/">
            <a className="rounded-lg px-3 py-2 border-solid hover:bg-slate-800 border-indigo-600">
              Home
            </a>
          </Link>
          <Link href="/mint">
          ...
          <Link href="/">
            <a className="rounded-lg px-3 py-2 border-solid hover:bg-slate-800 border-indigo-600 md:mr-4">
              Docs
            </a>
          </Link>
      </nav>
